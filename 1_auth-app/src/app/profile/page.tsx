...
export default function  ProfilePage() {
   ...
   const getUserDetails = async () =>{
    const res = await axios.get('/api/usrs.me')
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            ...
            <button onClick={getUserDetails}   className="bg-purple-500 mt-4 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">getUserDetails</button>
